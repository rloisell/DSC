...
/**
 * Servlet implementation class AdminActivityOptions
 */
public class AdminActivityOptions extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminActivityOptions() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session == null){
			...
			response.sendRedirect("jsp/adminactivityoptions.jsp");
		} // end else
	} // end doPost
} // end servlet
