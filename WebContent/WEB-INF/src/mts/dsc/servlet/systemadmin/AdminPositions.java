...
/**
 * Servlet implementation class AdminPositions
 */
public class AdminPositions extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminPositions() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session == null){
			...
			response.sendRedirect("jsp/adminpositions.jsp");
		} // end else
	} // end doPost
} // end servlet
