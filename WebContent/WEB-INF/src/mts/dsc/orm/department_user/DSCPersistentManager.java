...
public class DSCPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "DSC";
	...
	private DSCPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new DSCPersistentManager();
		}
