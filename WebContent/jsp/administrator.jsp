...
<div id="wrapper">
	...
	<div id="page">
      ...
      <div id="content">
        <div class="post">
          <h1 class="title"><a href="#"><%out.println(emp.getFirstName() +" "+ emp.getLastName() +" - " + emp.getPositionDesc());%>: Administrative Options</a></h1>
			<ul>
				<li><a href="/DSC/AdminUsers">Admin User's</a></li>
				<li><a href="/DSC/AdminPositions">Admin Positions</a></li>
				<li><a href="/DSC/AdminDepartments">Admin Departments</a></li>
				<li><a href="/DSC/AdminProjects">Admin Projects</a></li>
				<li><a href="/DSC/AdminExpense">Admin Expense</a></li>
				<li><a href="/DSC/AdminActivityOptions">Admin Activity Options</a></li>
			</ul>
		</div>
	  </div>
      <!-- end content -->
