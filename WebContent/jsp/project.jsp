...
<% 
boolean error=false;
Project[] pA=(Project[])sessionS.getAttribute("project");
if(pA==null) {error=true;}
else {
	for(Project p : pA) {
		out.println("<tr>");
		out.println("<td>"+p.getProjectNo()+"</td>");
...
<% 
if(error) {
	out.println("<p class=\"error\">Error loading projects.  Please try again later.</p>");
}
%>
	  </div>
      <!-- end content -->
